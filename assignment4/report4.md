...
The number of wraps: each block has a $16* 16=400$ array of threads and each warp includes 32 threads. So each block has $16* 16/ 32=8$ wraps. We have $ceil(800/16)* ceil(600/16)=15000$. Totally, we have $15000*8=12000$ warps.
